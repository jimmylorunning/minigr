...
ActiveRecord::Schema.define(version: 20150411043132) do
  ...
  add_index "comments", ["reader_id"], name: "index_comments_on_reader_id"
  ...
  create_table "copy_statuses", force: :cascade do |t|
    t.integer  "copy_id"
    t.string   "message"
  ...
  add_index "copy_statuses", ["copy_id"], name: "index_copy_statuses_on_copy_id"
  ...
  add_index "friendships", ["reader_id"], name: "index_friendships_on_reader_id"
  ...
  add_index "likes", ["reader_id"], name: "index_likes_on_reader_id"
